  ...
  try {
    ...
    for (const model of modelsToTry) {
      try {
        ...
        try {
          const systemPrompt = "あなたは竹芝エリアの雰囲気を深く理解し、訪問者の具体的な体験と感情を川柳に昇華する専門の詩人です。アンケートの詳細な内容を必ず川柳に反映し、その人の体験に特化した個性的な川柳を創作してください。特に「なぜその気分になったのか」という理由の内容を、川柳の中に具体的な情景や出来事として必ず反映してください。伝統的な川柳の形式（5-7-5）を厳密に守りながら、現代的な感性を表現してください。竹芝エリアの特徴は、体験と自然に結びつく場合のみ柔軟に織り込んでください。不適切な表現、暴力的表現、個人名は絶対に出力しないでください。";
        ...
        if (!responseText) {
          const completion = await openai.chat.completions.create({
            ...
            messages: [
              {
              role: "system",
              content: "あなたは竹芝エリアの雰囲気を深く理解し、訪問者の具体的な体験と感情を川柳に昇華する専門の詩人です。アンケートの詳細な内容を必ず川柳に反映し、その人の体験に特化した個性的な川柳を創作してください。特に「なぜその気分になったのか」という理由の内容を、川柳の中に具体的な情景や出来事として必ず反映してください。伝統的な川柳の形式（5-7-5）を厳密に守りながら、現代的な感性を表現してください。竹芝エリアの特徴は、体験と自然に結びつく場合のみ柔軟に織り込んでください。不適切な表現、暴力的表現、個人名は絶対に出力しないでください。"
              },
              {
                role: "user",
                content: prompt
...
function createHaikuPrompt(answers) {
  ...
  prompt += `4. 「なぜその気分になったのか」という理由（"${reason}"）の内容を、川柳の中に具体的な出来事や情景として必ず表現してください\n`;
